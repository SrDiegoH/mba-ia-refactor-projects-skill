...
order_bp.add_url_rule("/pedidos", "listar_todos_pedidos", require_admin(order_controller.list_all_orders), methods=["GET"])
...
order_bp.add_url_rule("/relatorios/vendas", "relatorio_vendas", require_admin(order_controller.sales_report), methods=["GET"])
